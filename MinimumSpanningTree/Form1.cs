...
namespace MinimumSpanningTree
{
	public partial class Form1 : Form
    {
        ...
        //Various variables
        public static int sizeOfNode = 40;
        ...
        private void algorithmToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Make sure you have vertices in the graph, ", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else if (graphIsConnected() == false) //check whether the graph is connected
            {
                MessageBox.Show("Graph must be connected graph.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                //disable drawing
